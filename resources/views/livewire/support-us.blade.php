...
<div class="grid gap-6 md:grid-cols-2 items-start mb-12">
    ...
    <div class="bg-white border rounded-lg shadow-sm p-6">
        ...
        @endif
            ...
            <form wire:submit.prevent="submitSupport" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" wire:model="supportName"
                ...
                <div>
                    ...
                    <input type="number" wire:model="supportAmount" min="2000"
                        class="w-full border rounded px-3 py-2"
        ...
        <div class="bg-white border rounded-lg shadow-sm p-6 flex flex-col items-center justify-center">
            ...
            <div class="lg:flex">
                <a href="{{ asset('assets/images/kbzpay.jpg') }}" target="blank"><img src="{{ asset('assets/images/kbzpay.jpg') }}" alt="QR Code" class="m-2 lg:m-7 w-60 h-60 border rounded shadow"></a>
                <a href="{{ asset('assets/images/wavemoney.jpg') }}" target="blank"><img src="{{ asset('assets/images/wavemoney.jpg') }}" alt="QR Code" class="m2 lg:m-7 w-60 h-60 border rounded shadow"></a>
            </div>
        ...
        <div class="text-center">
            <div class="bg-white border rounded-lg p-6">
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    ...
                    x-data
                    @click="$dispatch('open-share-popup', {
                        url: '{{ url()->current() }}',
                        title: 'My Page Title',
